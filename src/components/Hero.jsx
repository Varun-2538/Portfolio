...
import DualWindowHero from "./DualWindowHero"
...
const Hero = () => {
  ...
  // Optional: Add a toggle to switch between views
  // You can remove this if you only want the dual window view
  const toggleView = () => {
    setShowOriginal((prev) => !prev)
  }

  if (!showOriginal) {
    return <DualWindowHero />
  }
      ...
      >
        ...
        <div>
          ...
          <p className="text-white-200 text-[16px] sm:text-[20px] mt-5 max-w-lg leading-relaxed">
            I am a passionate full-stack developer with a knack for creating innovative solutions. I thrive on
            challenges and love to push the boundaries of technology.
          </p>
          <div className="mt-8">
            <p className="text-white-100 text-[22px] sm:text-[28px] font-semibold tracking-wide">Achievments</p>
